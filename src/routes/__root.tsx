        ...
        children: `
          (function() {
            try {
              ...
              const log1 = {location:'__root.tsx:blocking-script',message:'Blocking script start',data:{time:t0,timestamp:Date.now()},sessionId:'debug-session',runId:'run1',hypothesisId:'H1'};
              ...
              // #region agent log
              const logErr = {location:'__root.tsx:blocking-script',message:'Blocking script error',data:{error:String(e),time:performance.now()},timestamp:Date.now(),sessionId:'debug-session',runId:'run1',hypothesisId:'H1'};
...
function RootDocument({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    // #region agent log
    const t0 = performance.now();
    const log3 = {location:'__root.tsx:useEffect',message:'RootDocument useEffect start',data:{time:t0,i18nInitialized:i18n.isInitialized,i18nLanguage:i18n.language,docLang:document.documentElement.lang,hasLoadingClass:document.documentElement.classList.contains('i18n-loading'),hasResourceBundle:i18n.isInitialized?i18n.hasResourceBundle(i18n.language,'translation'):false},timestamp:Date.now(),sessionId:'debug-session',runId:'run1',hypothesisId:'H2'};
    ...
    const showPage = () => {
      // #region agent log
      const t1 = performance.now();
      const log4 = {location:'__root.tsx:showPage',message:'Removing i18n-loading class',data:{time:t1,elapsed:t1-t0,i18nLanguage:i18n.language,docLang:document.documentElement.lang,hasResourceBundle:i18n.hasResourceBundle(i18n.language,'translation')},timestamp:Date.now(),sessionId:'debug-session',runId:'run1',hypothesisId:'H4'};
      ...
      const log5 = {location:'__root.tsx:showPage',message:'Page visible',data:{time:t2,elapsed:t2-t0,hasLoadingClass:document.documentElement.classList.contains('i18n-loading')},timestamp:Date.now(),sessionId:'debug-session',runId:'run1',hypothesisId:'H4'};
    ...
    if (i18n.isInitialized) {
      ...
      // #region agent log
      const log6 = {location:'__root.tsx:useEffect',message:'i18n already initialized',data:{time:performance.now(),i18nLanguage:i18n.language,expectedLang:expectedLang,matches:expectedLang===i18n.language,hasResourceBundle:i18n.hasResourceBundle(i18n.language,'translation')},timestamp:Date.now(),sessionId:'debug-session',runId:'run1',hypothesisId:'H3'};
      ...
      if (expectedLang && i18n.language !== expectedLang) {
        // #region agent log
        const log7 = {location:'__root.tsx:useEffect',message:'Language mismatch, changing',data:{time:performance.now(),from:i18n.language,to:expectedLang},timestamp:Date.now(),sessionId:'debug-session',runId:'run1',hypothesisId:'H3'};
        ...
        i18n.changeLanguage(expectedLang).then(() => {
          // #region agent log
          const log8 = {location:'__root.tsx:useEffect',message:'Language changed',data:{time:performance.now(),newLang:i18n.language,hasResourceBundle:i18n.hasResourceBundle(i18n.language,'translation')},timestamp:Date.now(),sessionId:'debug-session',runId:'run1',hypothesisId:'H3'};
      ...
      // #region agent log
      const log9 = {location:'__root.tsx:useEffect',message:'i18n not initialized, waiting',data:{time:performance.now()},timestamp:Date.now(),sessionId:'debug-session',runId:'run1',hypothesisId:'H2'};
      ...
      const handleInit = () => {
        // #region agent log
        const log10 = {location:'__root.tsx:handleInit',message:'i18n initialized event',data:{time:performance.now(),i18nLanguage:i18n.language,docLang:document.documentElement.lang,hasResourceBundle:i18n.hasResourceBundle(i18n.language,'translation')},timestamp:Date.now(),sessionId:'debug-session',runId:'run1',hypothesisId:'H2'};
        ...
        if (expectedLang && i18n.language !== expectedLang) {
          // #region agent log
          const log11 = {location:'__root.tsx:handleInit',message:'Language mismatch after init, changing',data:{time:performance.now(),from:i18n.language,to:expectedLang},timestamp:Date.now(),sessionId:'debug-session',runId:'run1',hypothesisId:'H3'};
          ...
          i18n.changeLanguage(expectedLang).then(() => {
            // #region agent log
            const log12 = {location:'__root.tsx:handleInit',message:'Language changed after init',data:{time:performance.now(),newLang:i18n.language,hasResourceBundle:i18n.hasResourceBundle(i18n.language,'translation')},timestamp:Date.now(),sessionId:'debug-session',runId:'run1',hypothesisId:'H3'};
